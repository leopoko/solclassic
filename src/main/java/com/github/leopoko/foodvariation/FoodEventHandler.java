...
@Mod.EventBusSubscriber(modid = Foodvariation.MODID)
public class FoodEventHandler {
    ...
    private static void addFoodToHistory(UUID playerUUID, LinkedList<ItemStack> foodHistory, ItemStack eatenItem) {
        int maxHistorySize = FoodVariationConfig.CONFIG.maxFoodHistorySize.get();
    ...
    public static int getTimesEatenShort(Player player, ItemStack stack) {
        LinkedList<ItemStack> foodHistory = getFoodHistory(player);
        int maxShortFoodHistorySize = FoodVariationConfig.CONFIG.maxShortFoodHistorySize.get();
    ...
    static float calculateModifier(int timesEaten, int timesEatenShort) {
        List<? extends Double> decayModifiers = FoodVariationConfig.CONFIG.foodDecayModifiers.get();
        double shortmodifier = FoodVariationConfig.CONFIG.ShortfoodDecayModifiers.get();
